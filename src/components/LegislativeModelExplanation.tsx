    ...
    <section className={styles.modelNote} aria-label="Legislative model assumptions">
      <details className={styles.modelDisclosure}>
        ...
        <p>
          ...
          national chamber swing. Results use {source.sourceName}; current member
          rosters use {legislativeDataSources.congressionalRoster.sourceName}.
          Outputs are scenario simulations, not predictions.
        </p>
      </details>
    </section>
  );
